        ...
        <>
            <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                ...
                <div className="flex items-center justify-around">
                    ...
                    <button  className="mx-auto lg:mx-0 hover:underline gradient text-white font-bold rounded-full my-4 py-4 px-4 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out" onClick={(e)=>HaCndleDelete(e)} id={props.id} >
                        Delete
                    </button>
                </div>
                </div>
